...
export const ContainerScroll = ({
    ...
    return (
        <div
            className="h-[40rem] md:h-[60rem] flex items-center justify-center relative p-2 md:py-20"
            ref={containerRef}
        >
            <div
...
export const Card = ({
    ...
    return (
        ...
        >
            <div className="bg-gray-100 h-full w-full rounded-2xl grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 overflow-hidden p-4">
